...
class Enc_CNN_LSTM(nn.Module):
    ...
    def __init__(self, model_paras, embedding = None):
        ...
        self.lstm = getattr(nn, self.rnnType)(self.filters * len(self.Ks), self.lsDim[0], 1, batch_first=True, bidirectional = self.bidir, dropout= self.p_dropOut)
    ...
    def forward(self,x):
        ...
        E= self.embed(x) # Size: [batch * enc, doc_len, emb_dim]
        E = E.transpose(1,2)
